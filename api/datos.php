...
$ldr_light_pct = $data['ldr_light_pct'] ?? $data['irradiance_ldr'] ?? 0;
...
$linea = "$timestamp,{$data['current']},{$data['voltage']},{$data['power']},{$data['irradiance']}," .
    ...
    "$servo_angle,$servo_angle_v,$ldr_light_pct,$panel_adc,$v_adc,$acs_v\n";
...
if (!file_exists($archivo_csv)) {
    ...
    file_put_contents($archivo_csv,
        ...
        "Timestamp,I,V,P,Irr panel,LDR1r,LDR2r,LDR3r,LDR4r,LDR1v,LDR2v,LDR3v,LDR4v,ServoH,ServoV,LuzLDRpct,ADC36,Vadc36,ACSv\n");
